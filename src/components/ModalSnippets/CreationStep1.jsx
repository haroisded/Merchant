...
const CreationStep1 = () => {
  ...
  const this_session = useSession();
    ...
    async function handleCancel(){
      ...
      catch (err) { console.error('Failed to clear creator role:', err) }
    }
      ...
      <main className="flex-grow flex items-start justify-center px-4 py-6 md:px-6 md:py-10">
        <div className="bg-[#E9EDF0] w-full max-w-3xl rounded-3xl md:rounded-4xl p-6 md:p-10 shadow-sm">
          ...
          <div className="space-y-6 max-w-2xl mx-auto">
            ...
            {/* Category Options – hardcoded, no variables */}
            <div className="bg-white rounded-2xl p-3 md:p-5 border border-gray-100">
              <div className="grid grid-cols-3 gap-2 md:gap-3">
                
                {/* Purchasable */}
                <div className="p-2 md:p-6 rounded-lg md:rounded-2xl border-2 cursor-pointer transition-all group flex flex-col items-center text-center border-transparent hover:border-brand-secondary bg-brand-light">
